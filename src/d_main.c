...
static void IdentifyVersion(void)
{
	...
	D_AddFile(&startupwadfiles, va(pandf,srb2waddir,"SRB2P-graphics.pk3"));

	// Add the players
	D_AddFile(&startupwadfiles, va(pandf,srb2waddir,"SRB2P-chars.wad"));

	// Main code:
	D_AddFile(&startupwadfiles, va(pandf,srb2waddir,"SRB2P-main.pk3"));
	...
	D_AddFile(&startupwadfiles, va(pandf,srb2waddir,"SRB2P-maps.wad"));
...
D_AddFile(&startupwadfiles, va(pandf,srb2waddir,"SRB2P-patch.pk3"));	// SRB2P Patch. Used to patch quick things, always added last.
}
...
void D_SRB2Main(void)
{
	...
	W_VerifyFileMD5(1, ASSET_HASH_SRB2P_GRAPHICS_PK3);	// SRB2P-graphics.pk3
	W_VerifyFileMD5(2, ASSET_HASH_SRB2P_CHARS_WAD);		// SRB2P-chars.wad
	W_VerifyFileMD5(3, ASSET_HASH_SRB2P_MAIN_PK3);		// SRB2P-main.pk3
	...
	if (dedicated)
		...
		COM_ImmedExecute(va("exec \"%s"PATHSEP"SRB2Pautoexec.cfg\" -noerror\n", srb2home));
