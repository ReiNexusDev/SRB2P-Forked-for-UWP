...
consvar_t cv_cam_dist = CVAR_INIT ("cam_curdist", "256", CV_FLOAT|CV_ALLOWLUA, NULL, NULL);
consvar_t cv_cam_height = CVAR_INIT ("cam_curheight", "50", CV_FLOAT|CV_ALLOWLUA, NULL, NULL);
