...
{
#ifdef DEVELOP
	CONS_Printf("SRB2Persona %s-%s (%s %s) ", compbranch, comprevision, compdate, comptime);
#else
	CONS_Printf("SRB2Persona %s (%s %s %s %s) ", VERSIONSTRING, compdate, comptime, comprevision, compbranch);
#endif
